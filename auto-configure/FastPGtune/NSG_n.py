...
from optimizer_pobo_sa1 import PollingBayesianOptimization
from utils1 import RealEnv
...
if __name__ == '__main__':
    ...
    # 创建绝对路径的目录（如果不存在）
    # log_dir = "/home/yinzh/VDTuner/auto-configure/vdtuner"
    # os.makedirs(log_dir, exist_ok=True)

    # 将信息写入文件
    # log_file_path = os.path.join(log_dir, "zuihoujieguo1.log")
    with open(log_file_path, 'a') as f:
        f.write("结束时的系统时间{}\n".format(time.ctime()))
        f.write(f"Current memory usage: {current / 1024 / 1024:.2f} MB\n")
