...
namespace hnswlib {
    ...
    public:
        ...
        searchKnn(const void *query_data, size_t k,tableint etnterpoint) const {  //
        ...
        searchKnn2(const void *query_data, size_t k,std::vector<size_t> efsearchs,tableint etnterpoint) const {  //
